...
export default function DashboardPage() {
    ...
    const PrimaryButton = ({ children, href, className = "" }) => (
        <Link href={href}>
            ...
            >
                <Button onClick={() => { setShowLoginModal(true) }} variant="ghost" className={`px-6 py-3 bg-gradient-to-r from-blue-500 to-blue-600 text-white shadow-xl shadow-blue-500/30 border border-white/10 ${className}`}>
                    {children}
                </Button>
            </motion.div>
        </Link>
